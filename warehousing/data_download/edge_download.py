...
def _extract_study_details(selenium, download_filename):
    ...
    try:
        ...
        with open(download_filename, encoding='utf-8-sig')  as csvfile:
            ...
            for row in study_details:
                ...
                e = EdgeSiteStudy(
                    ...
                    project_site_start_date_nhs_permission=_date_or_none(row['Project site Date Start']),
                    ...
                    project_site_closed_date=_date_or_none(row['Project site Closing Date (Actual)']),
