...
SELECT
        'datalake_redcap_easyas' AS datalake_database_name,
        project_id,
        project_name,
        app_title,
        status
...
SELECT
        'datalake_redcap_internet' AS datalake_database_name,
        project_id,
        project_name,
        app_title,
        status
...
SELECT
        'datalake_redcap_n3' AS datalake_database_name,
        project_id,
        project_name,
        app_title,
        status
...
SELECT
        'datalake_redcap_national' AS datalake_database_name,
        project_id,
        project_name,
        app_title,
        status
...
SELECT
        'datalake_redcap_uhl' AS datalake_database_name,
        project_id,
        project_name,
        app_title,
        status
...
SELECT
        'datalake_redcap_uol' AS datalake_database_name,
        project_id,
        project_name,
        app_title,
        status
