...
from warehousing.database import DatalakeCiviCRMConnection, WarehouseCentralConnection, DWH_CONNECTION_NAME
...
def _copy_custom():
    ...
    with conn.query(sql=sql__field_details) as cursor:
        custom_fields = [(
            table_name,
